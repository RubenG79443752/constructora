...
<body link=blue vlink=purple class=x22>
    <div id="fijado"> <button type="button" onClick="window.print(); return false;" title="Imprimir planilla"><img src="{{ asset('imprimir.png') }}" alt="" width="60"></button> <a href="{{ url('generar_planilla') }}" id="fijado1"><img src="{{ asset('atras.png')}}" width="65" title="Retornar a generar planilla"></a></div>
...
<td colspan=7 class=x105 width=468 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>{{ $empresa->razon_social }}</td>
...
<td colspan=3 class=x105 width=183 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>{{ $empresa->n_nit }}</td>
...
<td class=x27></td>
<td class=x27></td>
<td colspan=3 class=x105 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>{{ $empresa->n_identificador }}</td>
<td class=x26></td>
<td class=x24>Nº DE EMPLEADOR (Caja de Salud)</td>
<td class=x26></td>
<td class=x87></td>
<td class=x87></td>
<td colspan=2 class=x105 style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>{{ $empresa->n_empleador_caja }}</td>
<td class=x26></td>
<td class=x26></td>
<td class=x25></td>
<td class=x26></td>
...
<td class=x103><span style='float:right'>{{ $mes }}</span></td>
 </tr>
...
<td class=x116 style='text-align:right;'>{{ $anio }}</td>
 </tr>
...
<tr height=40 style='mso-height-source:userset;height:30pt' id='r8'>
    <td height=37 class=x88 style='text-align:right;height:27.75pt;'>{{ $i }}</td>
    <td class=x89>{{ $value->doc_identidad }}</td>
    <td class=x90>{{ $value->primer_apellido.' '.$value->segundo_apellido.' '.$value->nombre }}</td>
    <td class=x90>{{ $value->pais }}</td>
    <td class=x91>{{ $value->fecha_nacimiento }}</td>
    <td class=x92>{{ $value->sexo }}</td>
    <td class=x90>{{ $value->cargo }}</td>
    <td class=x91>{{ $value->fecha_ingreso }}</td>
    <td class=x93>{{ $value->horas_pagadas }}</td>
    <td class=x94>{{ $value->dias_pagados }}</td>
    <td class=x51>{{ $value->haber_basico }}</td>
    <td class=x52>{{ $value->bono_antiguedad }}</td>
    <td class=x52>{{ $value->trabajo_extra_nocturno }}</td>
    <td class=x65>0</td>
    <td class=x68 align=right x:num="0" x:fmla="=SUM(K9:N9)" style='text-align:right;'>{{ $value->total_ganado }}</td>
    <td class=x67>{{ $value->afps }}</td>
    <td class=x53>{{ $value->rc_iva }}</td>
    <td class=x54>{{ $value->otros_descuentos }}</td>
    <td class=x68 align=right x:num="0" x:fmla="=SUM(P9:R9)" style='text-align:right;'>{{ $value->total_descuentos }}</td>
    <td class=x68 align=right x:num="0" x:fmla="=O9-S9" style='text-align:right;'>{{ $value->liquido_pagable }}</td>
    <td class=x63></td>
</tr>
@php
    $i++;
...
<td class=x60 align=right x:num="0" x:fmla="=SUM(K9:K28)">{{ $haber_basico }}</td>
<td class=x61 align=right x:num="0" x:fmla="=SUM(L9:L28)">{{ $bono_antiguedad }}</td>
<td class=x61 align=right x:num="0" x:fmla="=SUM(M9:M28)">{{ $trabajo_extra_nocturno }}</td>
<td class=x62 align=right x:num="0" x:fmla="=SUM(N9:N28)">0</td>
<td class=x70 align=right x:num="0" x:fmla="=SUM(O9:O28)">{{ $total_ganado }}</td>
<td class=x64 align=right x:num="0" x:fmla="=SUM(P9:P28)">{{ $afps }}</td>
<td class=x61 align=right x:num="0" x:fmla="=SUM(Q9:Q28)">{{ $rc_iva }}</td>
<td class=x62 align=right x:num="0" x:fmla="=SUM(R9:R28)">{{ $otros_descuentos }}</td>
<td class=x70 align=right x:num="0" x:fmla="=SUM(S9:S28)">{{ $total_descuentos }}</td>
<td class=x70 align=right x:num="0" x:fmla="=SUM(T9:T28)">{{ $liquido_pagable }}</td>
<td class=x31></td>
 </tr>
