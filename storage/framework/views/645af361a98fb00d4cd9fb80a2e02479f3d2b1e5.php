...
<?php if($theme === 'tailwind'): ?>
    <div>
        <?php if($component->filtersAreEnabled() && $component->filterPillsAreEnabled() && $component->hasAppliedFiltersWithValues()): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\constructora\constructora defensa borrador\vendor\rappasoft\laravel-livewire-tables\src\/../resources/views/components/tools/filter-pills.blade.php ENDPATH**/ ?>