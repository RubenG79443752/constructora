                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    En este apartado usted podra registrar su asistencia mediante GPS (Sistema de Posicionamiento Global) a traves de internet.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    En este apartado usted podra registrar su asistencia sin conexion a internet.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Ingreso a sistema, usted puede realizar la administracion basica de su empresa constructora.
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\constructora\constructora defensa borrador\resources\views/welcome.blade.php ENDPATH**/ ?>