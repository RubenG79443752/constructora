...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-tables::components.table.tr.plain','data' => ['wire:key' => 'bulk-select-message-'.e($table).'','class' => 'bg-indigo-50 dark:bg-gray-900 dark:text-white']]); ?>
...
<?php $component->withAttributes(['wire:key' => 'bulk-select-message-'.e($table).'','class' => 'bg-indigo-50 dark:bg-gray-900 dark:text-white']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-tables::components.table.td.plain','data' => ['colspan' => $colspan]]); ?>
...
<?php endif; ?>
    <?php elseif($theme === 'bootstrap-4' || $theme === 'bootstrap-5'): ?>
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-tables::components.table.tr.plain','data' => ['wire:key' => 'bulk-select-message-'.e($table).'']]); ?>
<?php $component->withName('livewire-tables::table.tr.plain'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\constructora\constructora defensa borrador\vendor\rappasoft\laravel-livewire-tables\src\/../resources/views/components/table/tr/bulk-actions.blade.php ENDPATH**/ ?>