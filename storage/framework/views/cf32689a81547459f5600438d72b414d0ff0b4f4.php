...
<?php elseif($theme === 'bootstrap-4' || $theme === 'bootstrap-5'): ?>
    <td <?php echo e($attributes->merge($customAttributes)
            ...
            ->except('default')); ?>><?php echo e($slot); ?></td>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\constructora\constructora defensa borrador\vendor\rappasoft\laravel-livewire-tables\src\/../resources/views/components/table/td.blade.php ENDPATH**/ ?>