    ...
    <div class="modal fade" id="entradaModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="entradaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <form method="POST" action="<?php echo e(route('asistenciaOff')); ?>"  role="form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::select('personal_id[]',$personal,(isset($asistencia->personal_id))? $asistencia->personal_id:null, ['multiple', 'size'=>'8','class' => 'form-select form-select','id'=>'personal_id',($accion=='insertar')? '':'disabled']); ?>
    ...
    <div class="modal fade" id="salidaModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="salidaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <form method="POST" action="<?php echo e(route('edit_asistenciaOff')); ?>"  role="form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <h1 class="text-danger">&#9313; Salida</h1>
                            <div class="form-group">
                                <?php echo Form::label('Personal'); ?>

                                <?php echo Form::select('personal_id_salida[]',$personal_salida,null, [ 'size'=>'10','multiple','class' => 'form-select form-select']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\constructora\constructora\resources\views/asistencia/asistencia_off.blade.php ENDPATH**/ ?>