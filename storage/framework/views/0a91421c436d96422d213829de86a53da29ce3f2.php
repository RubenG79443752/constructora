<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="col-md-2">
            <?php echo e(Form::hidden('anio', isset($planilla->anio)? $planilla->horas_pagadas:date('Y'), ['id'=>'anio','class' => 'form-control form-control-sm' . ($errors->has('anio') ? ' is-invalid' : ''), 'placeholder' => '0','min'=>'0'])); ?>
...
<?php /**PATH C:\xampp\htdocs\constructora\constructora defensa borrador\resources\views/planilla/form.blade.php ENDPATH**/ ?>