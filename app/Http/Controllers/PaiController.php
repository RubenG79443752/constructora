...
class PaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pais.index')
            ->with('success', 'Pais de nacionalidad creada correctamente.');
    }
    ...
    public function update(Request $request, Pai $pai)
    {
        ...
        return redirect()->route('pais.index')
            ->with('success', 'Pais de nacionalidad actualizada correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pais.index')
            ->with('success', 'Pais de nacionalidad eliminada con exito');
    }
}
